...
/*   Updated: 2025/08/26 13:31:53 by danpalac         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#ifndef METHODS_BONUS_H
# define METHODS_BONUS_H
...
void		calc_step_and_pos(double *step, double *pos, t_ray *r,
				int lineheight);
...
void		update_player_movement(t_game *g, double moveSpeed,
				double rotSpeed);
...
void		ft_draw_tile(mlx_image_t *img, t_vect2 vtile, size_t size,
				uint32_t color);
...
void		ft_draw_minimap_image(t_minimap *minimap, mlx_t *mlx,
				t_vect2 minimap_pos);
void		ft_draw_by_tile(char tile, mlx_image_t *img, t_vect2 pos,
				double scale);
void		ft_draw_line(mlx_image_t *img, t_vect2 start, t_vect2 end,
				uint32_t color);
