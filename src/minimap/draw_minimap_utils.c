...
/*   Updated: 2025/07/18 15:08:47 by mvidal-h         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	t_vect2	dist; // Distancia entre posicion de jugador y pared donde choca el rayo
	int		steps; // mayor numero de pasos entre horizontal y vertical para que la linea sea continua
	t_vect2	inc; // incremento en x e y para llegar a la pared (e2) desde el jugador (e1)
	t_vect2	aux; // coordenada auxiliar para recorrer los pasos entre e1 y e2
