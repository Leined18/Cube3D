...
/*   Updated: 2025/07/02 14:32:44 by daniel           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * This function does not remove the button from the render, it just frees its resources.
...
/**
 * Removes a button from the render deletes its image and label image. but does not
 * free the button structure itself. create a new image if you want to reuse the button.
 */
...
void ft_remove_button(mlx_t *mlx, t_button *btn)
{
    ...
    btn->active = false; // Set the button to inactive
}

/**
 * Removes all buttons from the render, freeing their resources.
 * This function does not free the button structure itself, it just frees its resources.
 ...
 * This function iterates through all buttons in the render and calls ft_free_button
